# 🎂 A Tiny Hand-Drawn Birthday Surprise

Hey there! Welcome to this little corner of the web. This is a cozy, interactive mini-project designed to send someone special a warm birthday wish. 
...
* 🪵 **Rosewood** (`#B46A72`) - For the hand-drawn sketch stars and floral accents.
* 🌿 **Sage Leaf** (`#A8B58A`) - For the background swirls.
...
*Made with care, code, and a touch of magic.* 
